...
export interface PlatformGroup { platform: string; presets: SizePreset[]; }
...
export const PLATFORMS: PlatformGroup[] = [
  ...
  { platform: "TikTok", presets: [{ id: "tt-video", label: "Video", w: 1080, h: 1920 }] },
  {
    platform: "YouTube",
    presets: [
  ...
  { platform: "Pinterest", presets: [{ id: "pin-pin", label: "Pin", w: 1000, h: 1500 }] },
  {
    platform: "App Store",
    presets: [
...
// Platforms that default to Fill and export PNG (icons/favicons).
export const PNG_PLATFORMS = ["App Store", "Favicon"];
