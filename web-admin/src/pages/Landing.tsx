...
// Real before/after pairs: royalty-free photos run through our own aiUncrop
// (Ideogram V3 Reframe). Generated by web-admin/scripts/gen-demos.cjs.
function Demo({ before, after }: { before: string; after: string }) {
  return (
    <div className="demo">
      <div className="demo-card before">
        <img src={before} alt="original photo" loading="lazy" />
        <span className="demo-tag">Original</span>
      </div>
      <span className="demo-arrow">›</span>
      <div className="demo-card after">
        <img src={after} alt="AI expanded photo" loading="lazy" />
      ...
      <div className="lp">
        ...
        <section className="lp-hero">
          ...
          <div style={{ marginTop: 36 }}>
            <Demo before="/demo/before.jpg" after="/demo/after.jpg" />
          </div>
        </section>
